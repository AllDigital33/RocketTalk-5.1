...
class MS5607
{
  public:
    ...
    float getAltitude2(void);
    char startConversionMB(char CMD);
    char startMeasurmentMB(void);
    char getDigitalValueMB(unsigned long &value);    
    char setValuesMB(unsigned long DTX, unsigned long DPX);


  private:
    const float P0 = (float) 1013.25;
